...
const routes = [
    ...
    },
    {
        ...
        children: [
            ...
            //Si se elimina el redirect y se quita el path a about se puede dejar el nombre
            //de la ruta principal 'pokemon' o se le agrega un nombre para eliminar el warning
            //en este caso "name: 'pokemon-redirect'"
            {
                path: '',
